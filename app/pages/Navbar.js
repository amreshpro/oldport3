...
const Navbar = () => {
  return (
    ...
    <div className="z-50 flex flex-col justify-evenly py-2 px-2 gap-6 sm:gap-4 sm:flex-row md:flex-col  sm:w-[90vw] shadow-xl bg-secondary text-white  rounded-2xl" >
